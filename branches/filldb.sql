...
INSERT INTO application(AppName, AppAddress, AppDescription, CustomerId)
VALUES ('Paint', 'C:\Windows\Paint', 'Pinting program',1),
('Oracle.exe', 'C:\ProgramFiles\Oracle', 'Database program from Oracle',3),
('Gadu-gadu', 'C:\GaduGadu\gg10', 'Communicator',2),
('VisualStudio', 'C:\ProgramFiles\VS', 'Developer environment from microsoft',4),
('Notepad', 'C:\windows\notepadFolder', 'Simple Notepad',5),
('MSSQL', 'C:\System\Programs\MS', 'SQL Server from microsoft',6),
('PES2009', 'C:\Play\PES', 'Football game in free time',7),
('Skype','C:\System\Programs\Skype','Communicator Skype',8),
('IceTower','C:\Play\Ice','Game for relax',9),
('Word','C:\System\Programs\Word','Microsoft Word',10),
('Fifa','C:\Play\Fifa','game for relax',1),
('OutLook','C:\System\Programs\Outlook','Mail Program',1),
('Graph','C:\System\Programs\Graph','Econometric program',2),
('BattleField','C:\Play\BF','Game for programmers',2),
('explorer','C:\windows\system','explorer of windows',3),
('eclipse','C:\System\Programs\eclipse','java program',4),
('Sopcast','C:\online\sopcast','streaming online',5),
('Adobe','C:\System\Programs\Adobe','Adobe Reader',5),
('Xamarin','C:\Addons\XamarinStudio','Addon to VS',6),
('ibm','C:\System\Programs\ibm','One of IBM programs to test',8)
...
----------------------------------------Events-----------------------------------------------
	...
	WHILE @i<10000
		...
		VALUES (
		((FLOOR(RAND() * (19)) + 1)), -- EventSiteId
		((FLOOR(RAND() * (3)) + 1)), --EventServiceId
		((FLOOR(RAND() * (9)) + 1)), --EventTypeId
		((FLOOR(RAND() * (98)) + 1)), --EventTypeId
		((FLOOR(RAND() * (298)) + 1)), --EventTypeId
		(DATEADD(DAY, ABS(CHECKSUM(NEWID()) % 3650/10), '2012-01-01')),
		'ExampleDescription' + CONVERT(VARCHAR(3),@i))
